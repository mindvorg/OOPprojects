...
/*    fun getSorted(comparator: Comparator<@UnsafeVariance T>) {

        return  listOfShapes.sortWith(comparator)

    }*/

    fun getSorted(comparator: Comparator<@UnsafeVariance T>): List<T> {
